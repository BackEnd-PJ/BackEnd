...
CREATE TABLE `memberTbl` (
  `memberid` varchar(50) NOT NULL,      -- 로그인 아이디
  `password` varchar(60) NOT NULL,      -- 비밀번호
  `name` varchar(30) NOT NULL,          -- 닉네임 
  `email` varchar(100) NOT NULL,        -- 대학 이메일
...
insert into memberTbl values('dongyang','dongyang','총괄관리자','dongyang@naver.com','동양미래대', '컴소과', '99999999', 'admin', 1);
...
ALTER TABLE productstbl ADD COLUMN views INT DEFAULT 0;
...
-- (나머지 '의류/신발', '가구/인테리어' INSERT 문에도 , 'yeonho2010'을 마지막에 추가해야 합니다.)
...
('아이패드 9세대 64GB 스그', 310000, '토정동', 37.5412, 126.9423, '전자기기', 'images/products/ipad_seongsu.jpg', '가성비.', 'yeonho2010');